...
const CreateAccount = (props) => (
  <div>
    <div className="registration__subtitle registration__subtitle--verification">
      <div className="registration__subtitle__item registration__subtitle__item--black"><Icon icon={ic_account_circle} />Create Account</div>
      <div className="registration__subtitle__item registration__subtitle__item--grey"><Icon icon={ic_explicit} />Email Verify</div>
    </div>
    ...
    <div className="registration__container--btn">
      <button className="serviceAgreement_btn btn" onClick={() => props.viewPost('verify')}>Create Account</button>
    </div>
    {/* <Verify /> */}
  </div>
);
